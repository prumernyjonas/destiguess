-- SQL script pro přidání lokací do databáze s obrázky
-- Spusť tento SQL v Supabase SQL Editor PO migraci 004 a 005

-- Nejdřív se ujisti, že máš unique constraint na title:
